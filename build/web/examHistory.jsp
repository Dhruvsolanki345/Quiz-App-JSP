...
<body class="bg-light">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <h2><strong>List of Students Attended '<%= request.getParameter("eName").toString()%>'</strong></h2>
    <div class="table-responsive">
      <table class="table table-hover table-striped">
        ...
        <tbody>
          <%
            ArrayList<Exams> list=pDAO.getAllExamStudent(request.getParameter("eName").toString());
            Exams exam;
