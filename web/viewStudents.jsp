...
<body class="bg-light">
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <ul class="navbar-nav fs-5">
          <li class="nav-item px-2">
            <a class="nav-link active" aria-current="page" href="viewStudents.jsp">Home</a>
          </li>
          <li class="nav-item px-2">
    ...
    <a href="AddStudent.jsp" style="position: absolute; right: 0; top: 0px;" class="btn btn-primary">Add User</a>
      ...
      <table class="table table-hover table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><%=user.getName() %></td>
            <td><%=user.getEmail() %></td>
            <td><a class="btn btn-info" href="AddStudent.jsp?userId=<%=user.getUserName() %>">Update</a></td>
          </tr>
          <%
                }
            } 
